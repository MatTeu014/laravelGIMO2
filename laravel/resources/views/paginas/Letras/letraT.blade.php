<x-layout titulo="Letra T">    
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #4782DA; padding-top: 20px; padding-bottom: 20px;">
    ...
    <!-- Seção de Conteúdo -->
        ...
        <div class="container" style="height: 800px; width:800px; border: 2px solid black; border: 2px solid black;">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="{{URL::to('/assets/img/letraT.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="{{URL::to('/assets/img/letraT_2.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraT_3.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraT_4.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <form method="post" action="{{ route('usuarioaumentarprogressoletraT') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/finalT.png') }}" class="d-block w-100" alt="...">
            <button @if(session('usuarios')->botaoT) disabled @endif type="submit" style="
