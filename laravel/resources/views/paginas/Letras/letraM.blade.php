  ...
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #4782DA; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="{{URL::to('/assets/img/letraM.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="{{URL::to('/assets/img/letraM_2.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraM_3.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraM_4.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraM_5.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraM_6.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <form method="post" action="{{ route('usuarioaumentarprogressoletram') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/finalM.png') }}" class="d-block w-100" alt="...">
            <button @if(session('usuarios')->botaoM) disabled @endif type="submit" style="
