<x-layout titulo="Letra V">    
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #4782DA; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
        <form method="post" action="{{ route('usuarioaumentarprogressoletrav') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/finalV.png') }}" class="d-block w-100" alt="...">
            <button @if(session('usuarios')->botaoV) disabled @endif type="submit" style="
