  ...
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #4782DA; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="{{URL::to('/assets/img/letraZ.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="{{URL::to('/assets/img/letraZ_2.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraZ_3.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraZ_4.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/letraZ_5.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <form method="post" action="{{ route('usuarioaumentarprogressoletraz') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/finalZ.png') }}" class="d-block w-100" alt="...">
            <button @if(session('usuarios')->botaoZ) disabled @endif type="submit" style="
