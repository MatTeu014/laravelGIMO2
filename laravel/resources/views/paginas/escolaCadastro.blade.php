<x-layout titulo="Cadastro de Escola">
   ...
   <!-- TÍTULO -->
   <br>
   <h2 class="card-title" style="text-align: center;">Cadastro de Escola</h2>
   <br>
   ...
   <div class="card"
      ...
      <div class="card-body">
       ...
       @endif
         <form action="/escolascadastrar" method="GET"> <!-- Ajuste o action se necessário -->
            ...
            <div>
               <button type="submit" class="btn btn-primary"
                  style="background-color: white; color:rgb(155, 109, 50); border-color: #000000; border-radius: 30px; border-width: 2px; font-weight: bold; font-size: 17px; width: 20%;">Cadastrar</button>
            </div>
            <br>
