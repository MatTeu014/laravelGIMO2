        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <form class="d-flex" role="search">
                <a href="escolaLogin" class="btn"
                    style="background-color: white; border-radius: 30px; padding: 6px 17px; font-size: 19px; width: 100px; text-align: center; rgb(155, 109, 50);">LOGIN</a>
            </form>
                ...
                <form action="turmascadastrar" method="GET"> <!-- Ajuste o action se necessário -->
                    ...
                    <div style="display: flex; gap: 20px; justify-content: center; margin-top: 20px;">
                        ...
                        <button type="submit" class="btn btn-primary"
                            style="background-color: white; color:rgb(155, 109, 50); border-color: #000000; border-radius: 30px; border-width: 2px; font-weight: bold; font-size: 17px; width: 150px;">Cadastrar</button>
