<x-layout titulo="Professor Turmas">
								...
								<div class="card" style="width: 24rem; height: 35vh; border-color: white;">
									<div class="card-body">
										<button name="turma" value="{{ $turma->id }}"
											style="font-size: 50px; border-radius: 30px; border-color: rgb(245, 101, 58); border-style: solid; background-color: white;">{{ $turma->nome }}</button>
									</div>
								</div>
							@endforeach
