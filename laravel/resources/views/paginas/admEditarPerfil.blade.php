		...
		<section class="py-5" style="padding-top: 80px;"> <!-- Ajuste o padding-top para evitar sobreposição -->
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="card"
						style="width:100%; border-color: #BDBDBD; border-width: 2px; margin: auto; border-radius: 30px; text-align: center;">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-12 d-flex justify-content-center" style="transform: translate(319px, -72px);">
									<a href="admPerfil"><button type="button"
