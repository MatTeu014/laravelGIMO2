  ...
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #34B764; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="{{URL::to('/assets/img/num2.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item" data-bs-interval="2000">
            <img src="{{URL::to('/assets/img/num2_2.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/num2_3.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{URL::to('/assets/img/num2_4.png')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <form method="post" action="{{ route('usuarioaumentarprogressonumero2') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/final2.png') }}" class="d-block w-100" alt="...">
            <button @if(session('usuarios')->botao2) disabled @endif type="submit" style="
