<x-layout titulo="Número 4">    
  <nav class="navbar navbar-expand-lg sticky-top" style="background-color: #34B764; padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
        <form method="post" action="{{ route('usuarioaumentarprogressonumero4') }}">
        @csrf
        <div style="position: relative;">
            <img src="{{ URL::to('/assets/img/final4.png') }}" class="d-block w-100" alt="...">
            <button @if(session('usuarios')->botao4) disabled @endif type="submit" style="
