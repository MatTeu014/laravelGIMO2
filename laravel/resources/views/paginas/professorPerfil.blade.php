              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite seu nome" Disabled
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="sobrenome" name="sobrenome"
                      placeholder="Digite seu sobrenome" Disabled
                      style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;"
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="senha" name="senha" placeholder="Senha" Disabled
                      style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;"
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="idade" name="idade" placeholder="Idade" Disabled
                      style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;"
                      value="{{ $professores->idade}} Anos">
                ...
                <div class="col-12 d-flex justify-content-center" style="transform: translate(300px, -72px);">
                  ...
                  <a href="{{ route('professoreditar2') }}"><button type="button"
