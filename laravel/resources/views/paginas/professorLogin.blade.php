<x-layout titulo="Login de Professor">    
...
<nav class="navbar navbar-expand-lg" style="background-color: rgb(245, 101, 58); padding-top: 20px; padding-bottom: 20px;">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <form class="d-flex" role="search">
            <a href="professorCadastro" class="btn ms-2" style="background-color: white; border: 0px solid black; border-radius: 30px; padding: 6px 18px; font-size: 20px; width: 150px; text-align: center; color:rgb(245, 140, 109);">CADASTRO</a>
        </form>
...
<!-- Titulo Login -->
<br><br>
<h2 class="card-title" style="text-align: center;">Login de Professor</h2>
<br>
...
<div class="card" style="width:50%; border-color:rgb(255, 119, 77); border-width: 2px; margin: auto; border-radius: 30px; text-align: center;">
    ...
    @endif
        <!-- Formulário de Login -->
        <form method="get"  action="/professorlogin">
