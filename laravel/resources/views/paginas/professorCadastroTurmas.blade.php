<x-layout titulo="Cadastro de Turmas do Professor">
	...
	<!-- TÍTULO -->
	<br>
	<h2 class="card-title" style="text-align: center;">Cadastro de Turmas Professor</h2>
	<br>
	...
	<section style="height: 50vh;">
		<div class="card"
			...
			<div class="card-body">
				...
				@endif
				<form action="professoresseriesturmacadastrarturma" method="GET"> <!-- Ajuste o action se necessário -->
					...
					<div style="display: flex; gap: 20px; justify-content: center; margin-top: 20px;">
						<a href="professorconsultarseries">
						...
						<button type="submit" class="btn btn-primary"
							style="background-color: white; color: rgb(255, 119, 77); border-color: #000000; border-radius: 30px; border-width: 2px; font-weight: bold; font-size: 17px; width: 150px;">Cadastrar</button>
